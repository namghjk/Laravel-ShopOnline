...
import { NavigateNext as NavigateNextIcon, CalendarToday as CalendarIcon } from '@mui/icons-material';
...
// components
import structure from '../../layouts/sidebar/SidebarStructure';
            ...
            >
                {
                    ...
                    structure.map((c: any) => {
                        if (window.location.pathname.includes(c.link) && c.link && c.label === 'Dashboard') {
                            return (
