...
import { PersonOutline as PersonOutlineIcon, Lock as LockIcon } from '@mui/icons-material';
...
const EditUser = () => {
    ...
    const deleteOneImage = (id: any) => {
        setData({
            ...data,
            avatar: data.avatar.filter((avatar: any) => avatar.id !== id),
        });
    };
                                ...
                                <>
                                    ...
                                    <div className={classes.galleryWrap}>
                                        {data && data.avatar && data.avatar.length !== 0
                                            ? data.avatar.map((avatar: any, idx: any) => (
